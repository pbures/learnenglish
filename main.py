...
lekce_adam10 = Lekce("Adam 10", 
    {
        ...
        'zaba':'frog',
        'predni':'front',
        'kaloň netopír [ovocny netopir]':'fruit bat',
        'gorila':'gorilla',
        'mněl':'had',
        'ja se schovavam':'I am hiding',
        'dejepis':'history',
        'kopita':'hooves',
        'konicek [zabava]':'hobby ies',
        'vypocetni technika':'I.T.',
        'hmyz':'insects',
        'prší [je pr3no]':'it is raining',
        'metr':'metre',
        'krk':'neck',
        'misto placka':'place',
        'bilozravec':'plant eater',
        ...
        'nakupovat':'shopping',
        'zpěvak':'singer',
        'sova sněžná[snowy]':'snowy owl',
        'stoln9 tenis':'table tennis',
        'ocas':'tail'
